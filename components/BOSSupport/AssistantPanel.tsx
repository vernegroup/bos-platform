...
export default function AssistantPanel({onClose}:AssistantPanelProps){
 const[voiceState,setVoiceState]=useState<MicrophoneState>("idle");const clientRef=useRef<VoiceSessionClient|null>(null);const[session,setSession]=useState<VoiceSessionSnapshot|null>(null);
