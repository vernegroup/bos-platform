...
export default async function StandardsPage(){
 ...
 return <>
  <section className="bos-app-intro bos-onboarding-view-head">
   <div><div className="bos-app-kicker">PRZYGOTUJ</div><h1>Standardy stanowisk</h1><p>Wzorce pracy używane do uruchamiania kolejnych wdrożeń. Opublikowana wersja pozostaje niezmienna dla procesów, które już z niej korzystają.</p></div>
