  ...
  return (
    <>
      ...
      <section className="bos-app-intro">
        ...
        <div className="bos-app-build-state"><span>ZAPIS</span><strong>DEMO / NIEAKTYWNY</strong></div>
      </section>
      <section className="bos-process-new">
        ...
        <div className="bos-process-new-lock"><span>04</span><div><strong>UTWÓRZ KARTĘ POSTĘPU</strong><p>Akcja zostanie uruchomiona po podłączeniu persistence. Nie symulujemy zapisu, który zniknąłby po odświeżeniu.</p></div></div>
      </section>
    </>
  );
}
