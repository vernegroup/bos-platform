...
export default async function CloseProcessPage({params}:{params:Promise<{processId:string}>}) {
 ...
 <label><span>POTWIERDZENIE FORMALNOŚCI</span><span><input type="checkbox" name="formalitiesConfirmed"/> Potwierdzam, że wymagane formalności dotyczące dopuszczenia do pracy zostały zweryfikowane poza BOS.</span><small>Wymagane wyłącznie dla decyzji GOTOWY.</small></label>
