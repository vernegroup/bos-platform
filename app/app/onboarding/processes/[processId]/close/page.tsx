...
export default async function CloseProcessPage({params}:{params:Promise<{processId:string}>}) {
 ...
 <aside className="bos-context-guide"><strong>FORMALNOŚCI POZA BOS</strong><p>BOS porządkuje wdrożenie operacyjne i nie zastępuje wymaganych szkoleń BHP, badań, uprawnień, instruktaży ani innych obowiązków formalnych. Zweryfikuj je w odpowiednim systemie lub dokumentacji.</p></aside>
